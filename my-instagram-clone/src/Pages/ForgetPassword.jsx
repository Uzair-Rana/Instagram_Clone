        ...
        <div className="min-h-screen flex flex-col justify-center items-center bg-[#fafafa] py-10">
            <div className="w-full max-w-sm bg-white border border-gray-300 p-6 flex flex-col items-center">
                ...
                <input
                    ...
                    className="w-full px-3 py-2 border rounded bg-gray-50 text-sm focus:outline-none focus:ring-1 focus:ring-gray-400 mb-3"
                />
            ...
            <div className="w-full max-w-sm text-center mt-4">
                <a
                    href="/"
                    className="block w-full bg-white border border-gray-300 py-3 text-sm hover:bg-gray-50"
                >
                    Back to login
                </a>
            </div>
