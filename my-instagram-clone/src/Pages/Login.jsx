...
function Login() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (err.response) {
                ...
                setError("No response from the server. Try again.");
            } else {
    ...
    return (
        <div className="w-full bg-gray-50 flex flex-col justify-center items-center py-10">
            <div className="w-full max-w-sm bg-white border border-gray-300 p-6 rounded-lg">
                ...
                <button className="w-full flex items-center justify-center gap-2 text-blue-700 font-semibold text-sm mb-4">
            ...
            <div className="w-full max-w-sm bg-white border border-gray-300 p-4 rounded-lg text-center mt-4">
