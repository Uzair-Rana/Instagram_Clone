        ...
        <div className="min-h-screen flex flex-col justify-center items-center bg-[#fafafa] py-10">
            <div className="w-full max-w-sm bg-white border border-gray-300 p-6 flex flex-col items-center">
                <div className="flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-[175px] h-[51px] mt-[36px] mb-[12px]" viewBox=".5 .5 998.999 282.085">
                ...
                <form className="w-full flex flex-col" onSubmit={handleSignup}>
                    ...
                    <input
                        ...
                        className="w-full px-3 py-2 border rounded bg-gray-50 text-sm mb-2 focus:outline-none focus:ring-1 focus:ring-gray-400"
                        required
                    />
                    ...
                    <input
                        ...
                        className="w-full px-3 py-2 border rounded bg-gray-50 text-sm mb-3 focus:outline-none focus:ring-1 focus:ring-gray-400"
                        required
                    />
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full bg-blue-500 text-white py-1.5 rounded text-sm font-semibold hover:bg-blue-600"
                    >
            ...
            <div className="w-full max-w-sm bg-white border border-gray-300 p-4 mt-4 text-center">
